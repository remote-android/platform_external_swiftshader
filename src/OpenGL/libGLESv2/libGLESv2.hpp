...
private:
	LibGLESv2exports *loadExports()
	{
		if(!libGLESv2)
		{
				...
				#if defined(__LP64__)
					const char *libGLESv2_lib[] = {"/vendor/lib64/" ANDROID_RELATIVE_PATH "/libGLESv2_swiftshader.so", "/system/lib64/" ANDROID_RELATIVE_PATH "/libGLESv2_swiftshader.so"};
				#else
					const char *libGLESv2_lib[] = {"/vendor/lib/" ANDROID_RELATIVE_PATH "/libGLESv2_swiftshader.so", "/system/lib/" ANDROID_RELATIVE_PATH "/libGLESv2_swiftshader.so"};
				#endif
