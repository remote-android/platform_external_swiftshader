...
private:
	LibGLES_CMexports *loadExports()
	{
		if(!libGLES_CM)
		{
				...
				#if defined(__LP64__)
					const char *libGLES_CM_lib[] = {"/vendor/lib64/" ANDROID_RELATIVE_PATH "/libGLESv1_CM_swiftshader.so", "/system/lib64/" ANDROID_RELATIVE_PATH "/libGLESv1_CM_swiftshader.so"};
				#else
					const char *libGLES_CM_lib[] = {"/vendor/lib/" ANDROID_RELATIVE_PATH "/libGLESv1_CM_swiftshader.so", "/system/lib/" ANDROID_RELATIVE_PATH "/libGLESv1_CM_swiftshader.so"};
				#endif
