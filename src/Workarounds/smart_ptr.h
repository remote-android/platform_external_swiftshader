...
#ifndef ANDROID_WORKAROUNDS_SMART_PTR_H_
#define ANDROID_WORKAROUNDS_SMART_PTR_H_

// Include this so that we fail badly if shared_ptr is native.
#include <memory>
...
#endif  // ANDROID_WORKAROUNDS_SMART_PTR_H_
